...
for ii=1:numPath
    ...
    fnProb=[fnTifBase,'_MaskTiles/idx-tiles.txt-GoogleNet-Prob-Stage2.csv'];
    fnTifMskEval=[fnTifBase,'_EvaluationMask.png'];
    fnImageProb=[fnTifBase,'_GoogleNet-Prob.png'];
    fnTifL8=[fnTif,'-L8.png'];
    fnPreviewOutput=[fnTifBase,'-preview-s2.png'];
    ...
    mskCLS=tifL8Resiz;
    mskCLS(:,:,1)=uint8(255*imclose(mskProb>0.98,se));
    mskCLS_Txt=insertText(mskCLS, [10,10], 'NN-Cls');
